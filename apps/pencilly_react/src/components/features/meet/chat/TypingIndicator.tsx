...
const TypingIndicator: FC<TypingIndicatorProps> = ({ names, className }) => {
  ...
  return (
    <div className={cn("row gap-2 p-3", className)}>
      <DotLoading  className="rounded-full bg-background-lighter border "/>
...
export const DotLoading = ({ className }: { className?: string }) => (
  <div
    className={cn(
...
export const BounceDot: FC<{ delay: number }> = ({ delay }) => (
  <span
