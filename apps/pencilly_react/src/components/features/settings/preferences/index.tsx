...
const Preferences = () => {
  ...
  const tCredit = useTranslations("credit_alert");
  ...
  return (
    <div className="col gap-6">
      <SettingItem title={t("preferences.credit_confirmations")}>
        <AppTypo variant="small" className="text-foreground-light mb-2">
        ...
        <div className="col gap-1">
          {CREDIT_FEATURES.map((feature) => {
            ...
            return (
              <div
                key={feature.key}
                className="row gap-3 items-center justify-between p-3 rounded-lg border bg-background hover:bg-muted/50 transition-colors"
              >
                <div className="row gap-3 items-center">
                  <div className="size-9 rounded-lg bg-primary/10 center">
                    <Icon
                      icon={feature.icon}
                  ...
                  <div className="col gap-0.5">
                    ...
                    <AppTypo variant="extraSmall" className="text-foreground-light">
                      {isDisabled
