import { arrayToMap, DEFAULT_ELEMENT_PROPS, DEFAULT_FONT_FAMILY, DEFAULT_GRID_SIZE, DEFAULT_GRID_STEP, DEFAULT_SIDEBAR, DEFAULT_TEXT_ALIGN, DEFAULT_VERTICAL_ALIGN, FONT_FAMILY, getLineHeight, getSizeFromPoints, getUpdatedTimestamp, normalizeLink, randomId, ROUNDNESS, updateActiveTool } from "@excalidraw/common";
import type { MarkOptional, Mutable } from "@excalidraw/common/utility-types";
import { bumpVersion, detectLineHeight, getContainerElement, getNonDeletedElements, getNormalizedDimensions, isArrowBoundToElement, isArrowElement, isElbowArrow, isFixedPointBinding, isInvisiblySmallElement, isLinearElement, isLineElement, isTextElement, isUsingAdaptiveRadius, isValidPolygon, LinearElementEditor, normalizeFixedPoint, refreshTextDimensions, syncInvalidIndices, updateElbowArrowPoints, validateElbowPoints } from "@excalidraw/element";
import type { ExcalidrawArrowElement, ExcalidrawElbowArrowElement, ExcalidrawElement, ExcalidrawElementType, ExcalidrawLinearElement, ExcalidrawSelectionElement, ExcalidrawTextElement, FixedPointBinding, FontFamilyValues, NonDeletedSceneElementsMap, OrderedExcalidrawElement, PointBinding, StrokeRoundness } from "@excalidraw/element/types";
