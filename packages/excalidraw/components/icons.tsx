...
export const WelcomeScreenTopToolbarArrow = createIcon(
    ...
    </>,
    {
        ...
        height: 78,
        fill: "none",
        transform: "scale(-1 1) translate(-41 0)",
    },
);
...
export const DiamondIcon = createIcon(
    <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="M5.92 5.92c2.238-2.237 3.357-3.355 4.666-3.724a5.2 5.2 0 0 1 2.828 0c1.309.369 2.428 1.487 4.665 3.725s3.356 3.356 3.725 4.665a5.2 5.2 0 0 1 0 2.828c-.369 1.309-1.487 2.428-3.725 4.665s-3.356 3.356-4.665 3.725a5.2 5.2 0 0 1-2.828 0c-1.309-.369-2.428-1.487-4.665-3.725s-3.356-3.356-3.725-4.665a5.2 5.2 0 0 1 0-2.828C2.565 9.277 3.683 8.158 5.92 5.92Z"
    />,
...
export const TriangleIcon = createIcon(
    <path
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="M5.593 9.225c2.246-3.602 3.368-5.403 4.84-5.945a4.53 4.53 0 0 1 3.134 0c1.472.542 2.594 2.343 4.84 5.945c2.527 4.053 3.79 6.08 3.568 7.753a4.66 4.66 0 0 1-1.599 2.938C19.1 21 16.733 21 12 21s-7.1 0-8.376-1.084a4.66 4.66 0 0 1-1.599-2.938c-.222-1.673 1.041-3.7 3.568-7.753Z"
    />,
    tablerIconProps,
);
...
export const PentagonIcon = createIcon(
    <path
        strokeWidth={1.5}
        d="M6.208 5.405C8.978 3.135 10.363 2 12 2s3.022 1.135 5.792 3.405l.256.21c2.286 1.874 3.429 2.81 3.815 4.126s-.073 2.71-.992 5.495l-.183.554c-.98 2.975-1.471 4.463-2.662 5.315c-1.65 1.182-4.126.853-6.026.853c-3.175 0-4.836 0-6.026-.853c-1.19-.852-1.681-2.34-2.662-5.315l-.183-.554c-.919-2.786-1.378-4.179-.992-5.495S3.666 7.49 5.952 5.616z"
    />,
    tablerIconProps,
);
...
export const EllipseIcon = createIcon(
  <circle cx={12} cy={12} r={10} strokeLinejoin="round" strokeWidth={1.5} />,
  tablerIconProps,
);

// tabler-icons: arrow-narrow-right
export const ArrowIcon = createIcon(
  <path strokeWidth={1.5} d="M4 12h16m0 0l-6-6m6 6l-6 6"></path>,
  tablerIconProps,
);
...
export const PenModeIcon = createIcon(
    <g strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}>
        <path
            d="m3 21l.858-3.002a2 2 0 0 1 .508-.864l13.84-13.841a1 1 0 0 1 1.414 0l1.086 1.086a1 1 0 0 1 0 1.414l-13.84 13.84a2 2 0 0 1-.864.51z"/>
        <path d="m16 5.499l2.379 2.378c1 1 1.5 1.5 1.5 2.122c0 .62-.5 1.12-1.5 2.12l-.88.88m-8.999 0l2.5 2.5"/>
    </g>,
    tablerIconProps,
);
...
export const TextIcon = createIcon(
    <g strokeLinecap="round" strokeWidth={1.5}>
        ...
        <path
            d="M12 3v18m0-18c1.387 0 3.17.03 4.588.176c.6.062.9.093 1.166.202a2.05 2.05 0 0 1 1.165 1.299C19 4.954 19 5.27 19 5.902M12 3c-1.387 0-3.17.03-4.588.176c-.6.062-.9.093-1.166.202A2.05 2.05 0 0 0 5.08 4.677C5 4.954 5 5.27 5 5.902"/>
    </g>,
    tablerIconProps,
);
...
export const extraToolsIcon = createIcon(
    <g strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}>
        <path
            d="M3.889 9.663C4.393 10 5.096 10 6.5 10s2.107 0 2.611-.337a2 2 0 0 0 .552-.552C10 8.607 10 7.904 10 6.5s0-2.107-.337-2.611a2 2 0 0 0-.552-.552C8.607 3 7.904 3 6.5 3s-2.107 0-2.611.337a2 2 0 0 0-.552.552C3 4.393 3 5.096 3 6.5s0 2.107.337 2.611a2 2 0 0 0 .552.552m10.92.337h5.382a.81.81 0 0 0 .724-1.17l-2.691-5.383a.809.809 0 0 0-1.448 0l-2.69 5.382A.81.81 0 0 0 14.808 10"></path>
        <circle cx={6.5} cy={17.5} r={3.5}></circle>
        <path d="M20.5 15v2.5c0 1.414 0 2.121-.44 2.56c-.439.44-1.146.44-2.56.44H15m-.5-6l5 5"></path>
    </g>,
    tablerIconProps,
);
