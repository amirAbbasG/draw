  ...
  const handleToolChange = (toolType: string, _pointerType?: string) => {
    if (toolType === "selection") {
      ...
      if (app.state.activeTool.type !== toolType) {
        ...
        app.setActiveTool({ type: toolType as ToolType, hidePopup: false });
      } else {
        app.setActiveTool({
  ...
  return (
    <div className="mobile-toolbar" ref={toolbarRef}>
      ...
      <ToolButton
        ...
        type="button"
        icon={EraserIcon}
        selected={activeTool.type === "eraser"}
        name="editor-current-shape"
      ...
      <ToolPopover
        ...
        onToolChange={(type: string) => {
          if (type === app.state.activeTool.type) {
            app.setActiveTool({
            ...
            if (
              ...
              app.setActiveTool({ type, hidePopup: false });
            }
          }
        }}
        displayedOption={
