import { BOUND_TEXT_PADDING, DEFAULT_REDUCED_GLOBAL_ALPHA, distance, ELEMENT_READY_TO_ERASE_OPACITY, FRAME_STYLE, getFontString, getVerticalOffset, invariant, isRTL, MIME_TYPES, THEME } from "@excalidraw/common";
import type { InteractiveCanvasRenderConfig, RenderableElementsMap, StaticCanvasRenderConfig } from "@excalidraw/excalidraw/scene/types";
import type { AppState, ElementsPendingErasure, InteractiveCanvasAppState, NormalizedZoomValue, PendingExcalidrawElements, StaticCanvasAppState, Zoom } from "@excalidraw/excalidraw/types";
import { isRightAngleRads, lineSegment, pointFrom, pointRotateRads, type GlobalPoint, type Radians } from "@excalidraw/math";
...
import {getElementAbsoluteCoords, getElementBounds, getTrianglePoints} from "./bounds";
import { getUncroppedImageElement } from "./cropElement";
import { getContainingFrame } from "./frame";
import { LinearElementEditor } from "./linearElementEditor";
import {generateRoughOptions, ShapeCache} from "./shape";
import { getBoundTextElement, getBoundTextMaxHeight, getBoundTextMaxWidth, getContainerCoords, getContainerElement } from "./textElement";
import { getLineHeightInPx } from "./textMeasurements";
import { hasBoundTextElement, isArrowElement, isFreeDrawElement, isImageElement, isInitializedImageElement, isLinearElement, isMagicFrameElement, isTextElement } from "./typeChecks";
import type { ElementsMap, ExcalidrawElement, ExcalidrawFrameLikeElement, ExcalidrawFreeDrawElement, ExcalidrawImageElement, ExcalidrawTextElement, ExcalidrawTextElementWithContainer, NonDeletedExcalidrawElement, NonDeletedSceneElementsMap } from "./types";
