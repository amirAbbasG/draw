import { DEFAULT_ELEMENT_PROPS, DEFAULT_FONT_FAMILY, DEFAULT_FONT_SIZE, DEFAULT_TEXT_ALIGN, DEFAULT_VERTICAL_ALIGN, getFontString, getLineHeight, getUpdatedTimestamp, randomId, randomInteger, VERTICAL_ALIGN } from "@excalidraw/common";
...
import type { Arrowhead, ElementsMap, ExcalidrawArrowElement, ExcalidrawElbowArrowElement, ExcalidrawElement, ExcalidrawEmbeddableElement, ExcalidrawFrameElement, ExcalidrawFreeDrawElement, ExcalidrawGenericElement, ExcalidrawIframeElement, ExcalidrawImageElement, ExcalidrawLinearElement, ExcalidrawLineElement, ExcalidrawMagicFrameElement, ExcalidrawTextContainer, ExcalidrawTextElement, ExcalidrawTriangleElement, FillStyle, FontFamilyValues, NonDeleted, RoundnessType, StrokeStyle, TextAlign, VerticalAlign } from "./types";
...
export const newElement = (
    ...
    if (opts.type === "triangle") {
        return newTriangleElement({...opts, type: "triangle"}) as NonDeleted<ExcalidrawGenericElement>;
    }
...
export const newTriangleElement = (
    opts: ElementConstructorOpts & { type?: "triangle" }
): NonDeleted<ExcalidrawTriangleElement> => {
    return _newElementBase<ExcalidrawTriangleElement>("triangle", opts);
};
